...
my $server_time = $ENV{'DATE_LOCAL'}      // scalar localtime();  # DATE_LOCAL might not exist; fallback works
...
<head>
  <meta charset="utf-8">
  <title>Perl GET Echo</title>
</head>
<body>
  <h1 align="center">GET Request Echo (Perl)</h1>
  <hr>
